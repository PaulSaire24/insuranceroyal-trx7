...
public class RequestLife extends RequestSchedule {
    ...
    public FinancingPlanBO createRequestCalculateQuoteRimac(FinancingPlanDTO input, QuotDetailDAO quotationDetails, ApplicationConfigurationService applicationConfigurationService) {
        ...
        List<FinanciamientoBO> financiamiento = input.getInstallmentPlans().stream().map(installment -> createCuotaFinanciamientoLife(installment,applicationConfigurationService)).collect(Collectors.toList());
    ...
    private FinanciamientoBO createCuotaFinanciamientoLife (InstallmentsDTO installmentsDTO,ApplicationConfigurationService applicationConfigurationService) {
        FinanciamientoBO financiamientoBO = new FinanciamientoBO();
